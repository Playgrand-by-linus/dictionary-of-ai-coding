<!--
  ...
  Source: dictionary-en/*.md, internal/Curriculum.en.md, internal/README.template.en.md
  Regenerate: npm run generate:en
-->
...
This is the English mirror. The primary version is Traditional Chinese — see [README.md](./README.md).
